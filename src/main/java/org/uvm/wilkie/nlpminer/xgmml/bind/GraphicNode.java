...
/**
 * <p>Java class for graphicNode complex type.
 * 
...
@XmlType(name = "graphicNode", propOrder = {
    "graphics"
})
    ...
    extends SimpleNode
{
    ...
    @XmlAttribute(name = "edgeanchor")
    protected String edgeanchor;
